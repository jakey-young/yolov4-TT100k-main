...
if __name__ == "__main__":
    ...
    video_save_path = ""
    video_fps = 25.0
    img_save_path = "D:\\PycharmProjects\\yolov4-TT100k-main\\results"
    if mode == "predict":
        '''
        ...
        '''
        while True:
            img_pth = input('Input image filename:') #"D:\\PycharmProjects\\yolov4-TT100k-main\\image"
            dirs = os.listdir(img_pth)
            for img in dirs:
                img = os.path.join(img_pth, img)
                try:
                    ...
                    r_image.save(img_save_path + "\\" + img.split("\\")[-1])
                   # r_image.show()
